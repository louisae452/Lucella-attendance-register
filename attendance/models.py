...
class Parent(models.Model):
    """
    Creates a parent entry.
    Related to :model:`auth.User`
    Requires users to be in group parent
    """
...
OPTION = ((0, "MJB"), (1, "MJA"), (2, "MSB"), (3, "MSA"), (4, "FJB"),
          (5, "FJA"), (6, "FSB"), (7, "FSA"), (8, "Undetermined"))
...
class Teacher(models.Model):
    """
    Creates a teacher entry.
    Related to  :model:`auth.User`
    Requires users to belong to group teacher"""
...
ROOM = ((0, 'English room'), (1, 'Maths room'), (2, 'Lab'), (3, 'Sports Hall'),
        (4, 'Gym'), (5, 'Music A'), (6, 'Music B'))
...
SESSION = ((0, 'MomoA'), (1, 'MoafA'), (2, 'TumoA'), (3, 'TuafA'),
           (4, 'WemoA'), (5, 'WeafA'), (6, 'ThmoA'), (7, 'ThafA'),
...
class Timetable(models.Model):
    ...
    Related to :model:`attendance.Subject`
    """
    ...
    def __str__(self):
        return (
            f"{self.get_day_display()} {self.get_session_display()} "
            f"Group: {self.get_group_display()}")
...
class DailyRegister(models.Model):
    """
    Creates a DailyRegister entry.
    Related to :modelL`attendance.Timetable`, :model:`attendance.Student`
    """
